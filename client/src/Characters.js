    ...
    <div>
      ...
      <div className="instructions">
        ...
        <div className="instructions-p">
          <p>
            And we have a Demogorgon to fight! You can choose four of our
            Stranger Things friends to go with you, but pick carfully. You need
            enough strength to defeat the unbeatable Demogorgon. Once you select
            your team, choose your team name and then FIGHT!
          </p>
        </div>
      </div>
      ...
      <div className="fight-button-container">
        <button className="fight-button" onClick={handleTeamClick}>
          Travel into Upside Down
        </button>
      </div>
    </div>
  );
